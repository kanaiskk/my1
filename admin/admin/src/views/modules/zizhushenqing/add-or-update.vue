	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="发放状态" prop="fafangzhuangtai" >
					<el-select :disabled="ro.fafangzhuangtai" v-model="ruleForm.fafangzhuangtai" placeholder="请选择发放状态" >
						<el-option
							v-for="(item,index) in fafangzhuangtaiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="发放状态" prop="fafangzhuangtai" >
					<el-input v-model="ruleForm.fafangzhuangtai"
						placeholder="发放状态" readonly></el-input>
				</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='fafangzhuangtai'){
							this.ruleForm.fafangzhuangtai = obj[o];
							this.ro.fafangzhuangtai = true;
							continue;
						}
					...
					this.ruleForm.fafangzhuangtai = '未发放'; 				}
				// 获取用户信息
				this.$http({
				...
				this.fafangzhuangtaiOptions = "已发放,未发放".split(',')
