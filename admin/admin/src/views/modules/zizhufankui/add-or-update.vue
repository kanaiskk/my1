	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="反馈内容" prop="fankuineirong" >
					<el-input v-model="ruleForm.fankuineirong" placeholder="反馈内容" clearable  :readonly="ro.fankuineirong"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="反馈内容" prop="fankuineirong" >
					<el-input v-model="ruleForm.fankuineirong" placeholder="反馈内容" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="反馈详情" prop="fankuixiangqing" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.fankuixiangqing" label="反馈详情" prop="fankuixiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.fankuixiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.fankuixiangqing = this.ruleForm.fankuixiangqing.replace(reg,'../../../helpPoorChildren/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `zizhufankui/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zizhufankuiCrossAddOrUpdateFlag = false;
											this.parent.search();
