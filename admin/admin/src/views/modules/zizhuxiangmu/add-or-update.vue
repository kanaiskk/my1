	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="资助类型" prop="zizhuleixing" >
					<el-select :disabled="ro.zizhuleixing" v-model="ruleForm.zizhuleixing" placeholder="请选择资助类型" >
						<el-option
							v-for="(item,index) in zizhuleixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="资助类型" prop="zizhuleixing" >
					<el-input v-model="ruleForm.zizhuleixing"
						placeholder="资助类型" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="资助描述" prop="zizhumiaoshu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="资助描述"
					v-model="ruleForm.zizhumiaoshu" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.zizhumiaoshu" label="资助描述" prop="zizhumiaoshu" >
				<span class="text">{{ruleForm.zizhumiaoshu}}</span>
			</el-form-item>
			<el-form-item v-if="type!='info'"  label="资助详情" prop="zizhuxiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.zizhuxiangqing" 
					class="editor"
					myQuillEditor="zizhuxiangqing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.zizhuxiangqing" label="资助详情" prop="zizhuxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.zizhuxiangqing"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='zizhumiaoshu'){
							this.ruleForm.zizhumiaoshu = obj[o];
							this.ro.zizhumiaoshu = true;
							continue;
						}
						if(o=='zizhuxiangqing'){
							this.ruleForm.zizhuxiangqing = obj[o];
							this.ro.zizhuxiangqing = true;
							continue;
						}
						if(o=='clicktime'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.zizhuxiangqing = this.ruleForm.zizhuxiangqing.replace(reg,'../../../helpPoorChildren/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
