<template>
	<div :style='{"width":"1200px","padding":"20px","margin":"10px auto","position":"relative","background":"none"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 calc(50% - 630px)","margin":"0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250204/b980e0170638444f96e5c6db7256aac3.png) no-repeat center","width":"auto","lineHeight":"50px","fontSize":"22px","fontWeight":"600"}'>我的收藏</div>
